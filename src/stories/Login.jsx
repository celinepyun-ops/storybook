...
/** Login page */
export const Login = ({ onLogin, onSignUpClick, onForgotPassword }) => {
        ...
        <form className="oai-auth__form" onSubmit={handleSubmit}>
          <div className="oai-auth__field">
            <input
              ...
              required
            />
            <label className="oai-auth__label" htmlFor="login-email">Email address*</label>
          </div>
          ...
          <div className="oai-auth__field">
            ...
            />
            <label className="oai-auth__label" htmlFor="login-password">Password*</label>
            <button
              type="button"
          ...
          <div className="oai-auth__forgot">
            <button type="button" onClick={onForgotPassword}>Forgot password?</button>
          </div>

          <button type="submit" className="oai-auth__submit">Continue</button>
        </form>
